...
export default function WhatsAppButton() {
  ...
  // Aguarda a hidratação para acionar a animação de entrada
  useEffect(() => {
  ...
  return (
    <a
      ...
      className={`wpp-btn ${mounted ? 'wpp-btn--visible' : ''}`}
    ...
    >
      ...
      {/* Tooltip — visível apenas no desktop via CSS */}
      <span className="wpp-tooltip" aria-hidden="true">Fale Conosco</span>
    </a>
  );
}
